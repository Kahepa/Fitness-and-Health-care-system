    ...
    <div className="flex h-screen">
      <div className="w-1/2 bg-blue-500 flex flex-col justify-center items-center text-white p-8">
        ...
        {otp.map((digit, index) => (
         <input
          key={index}
             className="w-16 h-16 bg-white text-blue-500 text-4xl flex justify-center items-center rounded-l"
             type="text"
             maxLength={1}
             value={digit}
             autoFocus={index === 0}
        ...
        <button className="bg-black text-white px-6 py-3 rounded-lg mb-4">Verify with OTP</button>
